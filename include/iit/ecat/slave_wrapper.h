...
/**
 * A dummy ESC Wrapper for the EtherCAT network switch
 */
class SwitchESCWrapper : public EscWrapper
{
public:
    SwitchESCWrapper(const ec_slavet& slave_descriptor) : EscWrapper(slave_descriptor) {}
